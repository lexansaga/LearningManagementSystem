...
async function submitAnswer(data,actid,studentid,programclass,course,actType) {
    ...
    if(actType=="Exam"){
        ...
        formData.append("correctanswers",JSON.stringify(temp));
        formData.append("score",currentPoints);
                ...
                if(element.activitytype=="Multiple" ){
                    ...
                    if(element.question.trim()==eachelement.ariaLabel){
                        ...
                        if(element.activitytype=="Identification"){
                            let judge = "wrong";
                            if(element.answer.trim().toLowerCase()==eachelement.value.trim().toLowerCase()){
