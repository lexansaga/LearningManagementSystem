...
<!DCTYPE HTML>
	...
	<head>
		<title> Welcome to Educa Academy! </title>
				...
				<div class="box">
					...
					<div class="right">
						<div class="form">
							...
							<h1><b>Educa Academy</h1></b>
							<p><b>Information System</b></p>
							<p>
							<p><i>Educa Academy is a private Ivy League research university in
							...
							<form action="index.php" method="POST">
								...
								<button type="submit" name="login" class="btn btn-Warning btn-login">LOGIN</button>
							</form>
